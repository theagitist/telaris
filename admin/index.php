...
<body class="font-sans bg-gray-100 min-h-screen">
                        ...
                        <div class="space-y-4">
                            <?php foreach ($apiKeys as $key): ?>
                                <div class="p-4 border border-gray-300 rounded <?php echo $key['is_active'] ? 'bg-white' : 'bg-gray-100'; ?>">
                                    ...
                                    <div class="mt-2 text-xs text-gray-500 space-y-1">
                                        <p><strong>Created:</strong> <?php echo date('Y-m-d H:i:s', strtotime($key['created_at'])); ?></p>
                                        <?php if ($key['last_used_at']): ?>
                                            <p><strong>Last Used:</strong> <?php echo date('Y-m-d H:i:s', strtotime($key['last_used_at'])); ?></p>
                                        <?php else: ?>
    ...
    <script>
        ...
        function showTab(tabName) {
            ...
            const tabs = ['api-keys', 'users', 'php-info'];
            tabs.forEach(tab => {
            ...
            // Remove edit_user if switching away from users tab
            if (tabName !== 'users') {
