...
<head>
    ...
    <script src="js/tailwind.min.js?v=5.1.0"></script>
    ...
    <script type="importmap">
        {
            "imports": {
                ...
                "./telaris-network.js": "./js/telaris-network.js?v=5.1.0",
                "./network-manager.js": "./js/network-manager.js?v=5.1.0",
                "./geometry-manager.js": "./js/geometry-manager.js?v=5.1.0",
                "./api.js": "./js/api.js?v=5.1.0",
                "./telaris-node-icons.js": "./js/telaris-node-icons.js?v=5.1.0",
                "./themes.js": "./js/themes.js?v=5.1.0"
            }
        }
    </script>
    <script type="module" src="js/main.js?v=5.1.0"></script>
</body>
</html>