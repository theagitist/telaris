    ...
    <script type="importmap">
        {
            "imports": {
                ...
                "./telaris-network.js": "./js/telaris-network.js?v=3.6.7",
                "./network-manager.js": "./js/network-manager.js?v=3.6.7",
                "./geometry-manager.js": "./js/geometry-manager.js?v=3.6.7",
                "./api.js": "./js/api.js?v=3.6.7",
                "./telaris-node-icons.js": "./js/telaris-node-icons.js?v=3.6.7"
            }
        }
    </script>
    <script type="module" src="js/main.js?v=3.6.7"></script>
</body>
</html>