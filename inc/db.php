...
function db_default_project_info_rows(string $enName = 'Telaris', string $enDescription = 'Weaving memory'): array {
    return [
        'en' => [
            ...
            'editor_hotglue_create_note' => 'Save the wormhole first, then reopen it to compose the hotglue page. Add it with this tab selected to start in Hotglue mode.',
        ...
        'es' => [
            ...
            'editor_hotglue_create_note' => 'Guarda primero el agujero de gusano, luego vuelve a abrirlo para componer la página hotglue. Agrégalo con esta pestaña seleccionada para empezar en modo Hotglue.',
        ...
        'pt' => [
            ...
            'editor_hotglue_create_note' => 'Salve primeiro o buraco de minhoca, depois reabra-o para compor a página hotglue. Adicione-o com esta aba selecionada para começar no modo Hotglue.',
        ...
        'fr' => [
            ...
            'editor_hotglue_create_note' => 'Enregistre d\'abord le trou de ver, puis rouvre-le pour composer la page hotglue. Ajoute-le avec cet onglet sélectionné pour démarrer en mode Hotglue.',
