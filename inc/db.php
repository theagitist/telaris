...
function db_default_project_info_rows(string $enName = 'Telaris', string $enDescription = 'Weaving memory'): array {
    return [
        'en' => [
            ...
            'admin_pluriverse_field_galaxies_empty' => 'No galaxies yet. The application registers this instance now; new galaxies are picked up automatically as you create them.',
