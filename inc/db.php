...
function db_default_project_info_rows(string $enName = 'Telaris', string $enDescription = 'Weaving memory'): array {
    return [
        'en' => [
            ...
            'gem_fractal_intro' => 'Read-only diagnostic. Measures the structure of this galaxy\'s keyword-shared graph (wormholes linked when they share a keyword).',
        ...
        'es' => [
            ...
            'gem_fractal_intro' => 'Diagnóstico de solo lectura. Mide la estructura del grafo de palabras clave compartidas de esta galaxia (los agujeros de gusano se enlazan cuando comparten una palabra clave).',
        ...
        'pt' => [
            ...
            'gem_fractal_title' => 'Perfil fractal',
            'gem_fractal_intro' => 'Diagnóstico somente leitura. Mede a estrutura do grafo de palavras-chave compartilhadas desta galáxia (os buracos de minhoca se ligam quando compartilham uma palavra-chave).',
        ...
        'fr' => [
            ...
            'gem_fractal_intro' => "Diagnostic en lecture seule. Mesure la structure du graphe de mots-clés partagés de cette galaxie (les trous de ver sont reliés lorsqu'ils partagent un mot-clé).",
