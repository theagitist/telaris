...
const PROJECT_INFO_KEYS = [
    ...
    'gem_fractal_chart_caption', 'gem_fractal_axis_x', 'gem_fractal_axis_y', 'gem_fractal_spread_label',
    'gem_fractal_network_label', 'gem_fractal_network_caption',
    'gem_fractal_degree_label', 'gem_fractal_degree_caption', 'gem_fractal_degree_axis_x', 'gem_fractal_degree_axis_y',
    'gem_fractal_gen_dims_label', 'gem_fractal_gamma_label',
    'gem_fractal_stat_nodes', 'gem_fractal_stat_edges', 'gem_fractal_stat_meandeg',
    'gem_fractal_stat_density', 'gem_fractal_stat_components', 'gem_fractal_stat_diameter',
    'gem_fractal_summary_few', 'gem_fractal_summary_dense', 'gem_fractal_summary_moderate',
    'gem_fractal_summary_split', 'gem_fractal_summary_large', 'gem_fractal_chart_unavailable',
...
function db_default_project_info_rows(string $enName = 'Telaris', string $enDescription = 'Weaving memory'): array {
    return [
        'en' => [
            ...
            'gem_fractal_network_label' => 'Wormhole network',
            'gem_fractal_network_caption' => 'Each dot is a wormhole; lines join wormholes that share a keyword. Bigger dots are more-connected hubs.',
            'gem_fractal_degree_label' => 'Connection spread',
            'gem_fractal_degree_caption' => 'How many wormholes have how many connections. A tall spike on the left with a long tail to the right means a few busy hubs and many lightly-linked wormholes.',
            'gem_fractal_degree_axis_x' => 'links per wormhole',
            'gem_fractal_degree_axis_y' => 'number of wormholes',
            'gem_fractal_chart_caption' => 'Each dot is a level of link-density found in the galaxy. A wide arc means it mixes densely and sparsely linked areas; a narrow one means the linking is uniform. The red ring marks where most of the galaxy sits.',
            'gem_fractal_axis_x' => 'link concentration (α)',
            'gem_fractal_axis_y' => 'share of the galaxy',
            'gem_fractal_spread_label' => 'spread',
            ...
            'gem_fractal_stat_density' => 'Link density',
            'gem_fractal_stat_components' => 'Connected pieces',
            'gem_fractal_stat_diameter' => 'Steps across',
            'gem_fractal_summary_few' => 'Just a few connected wormholes so far.',
            'gem_fractal_summary_dense' => 'Small and tightly interlinked: almost every wormhole shares a keyword with almost every other.',
            'gem_fractal_summary_moderate' => 'A small, loosely linked set of wormholes.',
            'gem_fractal_summary_split' => 'The wormholes fall into separate groups that share no keywords.',
            'gem_fractal_summary_large' => 'A large galaxy; showing the counts for now.',
            'gem_fractal_chart_unavailable' => 'A detailed shape chart needs more wormholes, and looser keyword linking, than this galaxy has yet.',
        ...
        'es' => [
            ...
            'gem_fractal_network_label' => 'Red de agujeros de gusano',
            'gem_fractal_network_caption' => 'Cada punto es un agujero de gusano; las líneas unen los que comparten una palabra clave. Los puntos más grandes son nodos más conectados.',
            'gem_fractal_degree_label' => 'Distribución de conexiones',
            'gem_fractal_degree_caption' => 'Cuántos agujeros de gusano tienen cuántas conexiones. Un pico alto a la izquierda con una cola larga a la derecha indica unos pocos nodos muy activos y muchos poco enlazados.',
            'gem_fractal_degree_axis_x' => 'enlaces por agujero de gusano',
            'gem_fractal_degree_axis_y' => 'número de agujeros de gusano',
            'gem_fractal_chart_caption' => 'Cada punto es un nivel de densidad de enlaces en la galaxia. Un arco ancho significa que mezcla zonas muy conectadas y poco conectadas; uno estrecho significa que el enlace es uniforme. El anillo rojo marca dónde se concentra la mayor parte de la galaxia.',
            'gem_fractal_axis_x' => 'concentración de enlaces (α)',
            'gem_fractal_axis_y' => 'parte de la galaxia',
            'gem_fractal_spread_label' => 'amplitud',
            ...
            'gem_fractal_stat_density' => 'Densidad de enlaces',
            'gem_fractal_stat_components' => 'Piezas conectadas',
            'gem_fractal_stat_diameter' => 'Pasos de extremo a extremo',
            'gem_fractal_summary_few' => 'Solo unos pocos agujeros de gusano conectados por ahora.',
            'gem_fractal_summary_dense' => 'Pequeña y muy interconectada: casi cada agujero de gusano comparte una palabra clave con casi todos los demás.',
            'gem_fractal_summary_moderate' => 'Un conjunto pequeño de agujeros de gusano poco enlazados.',
            'gem_fractal_summary_split' => 'Los agujeros de gusano se reparten en grupos separados que no comparten palabras clave.',
            'gem_fractal_summary_large' => 'Una galaxia grande; por ahora se muestran los conteos.',
            'gem_fractal_chart_unavailable' => 'Un gráfico detallado de la forma necesita más agujeros de gusano, y un enlace menos denso, de los que esta galaxia tiene todavía.',
        ...
        'pt' => [
            ...
            'gem_fractal_network_label' => 'Rede de buracos de minhoca',
            'gem_fractal_network_caption' => 'Cada ponto é um buraco de minhoca; as linhas unem os que compartilham uma palavra-chave. Os pontos maiores são nós mais conectados.',
            'gem_fractal_degree_label' => 'Distribuição de conexões',
            'gem_fractal_degree_caption' => 'Quantos buracos de minhoca têm quantas conexões. Um pico alto à esquerda com uma cauda longa à direita indica poucos nós muito ativos e muitos pouco ligados.',
            'gem_fractal_degree_axis_x' => 'ligações por buraco de minhoca',
            'gem_fractal_degree_axis_y' => 'número de buracos de minhoca',
            'gem_fractal_chart_caption' => 'Cada ponto é um nível de densidade de ligações na galáxia. Um arco largo significa que ela mistura áreas muito conectadas e pouco conectadas; um estreito significa que a ligação é uniforme. O anel vermelho marca onde fica a maior parte da galáxia.',
            'gem_fractal_axis_x' => 'concentração de ligações (α)',
            'gem_fractal_axis_y' => 'parte da galáxia',
            'gem_fractal_spread_label' => 'amplitude',
            ...
            'gem_fractal_stat_density' => 'Densidade de ligações',
            'gem_fractal_stat_components' => 'Peças conectadas',
            'gem_fractal_stat_diameter' => 'Passos de ponta a ponta',
            'gem_fractal_summary_few' => 'Apenas alguns buracos de minhoca conectados por enquanto.',
            'gem_fractal_summary_dense' => 'Pequena e muito interligada: quase todo buraco de minhoca compartilha uma palavra-chave com quase todos os outros.',
            'gem_fractal_summary_moderate' => 'Um conjunto pequeno de buracos de minhoca pouco ligados.',
            'gem_fractal_summary_split' => 'Os buracos de minhoca se dividem em grupos separados que não compartilham palavras-chave.',
            'gem_fractal_summary_large' => 'Uma galáxia grande; por enquanto mostrando as contagens.',
            'gem_fractal_chart_unavailable' => 'Um gráfico detalhado da forma precisa de mais buracos de minhoca, e de ligações menos densas, do que esta galáxia tem ainda.',
        ...
        'fr' => [
            ...
            'gem_fractal_network_label' => 'Réseau des trous de ver',
            'gem_fractal_network_caption' => 'Chaque point est un trou de ver ; les lignes relient ceux qui partagent un mot-clé. Les points plus grands sont des pôles plus connectés.',
            'gem_fractal_degree_label' => 'Répartition des connexions',
            'gem_fractal_degree_caption' => 'Combien de trous de ver ont combien de connexions. Un pic élevé à gauche avec une longue traîne à droite indique quelques pôles très actifs et beaucoup de trous de ver peu reliés.',
            'gem_fractal_degree_axis_x' => 'liens par trou de ver',
            'gem_fractal_degree_axis_y' => 'nombre de trous de ver',
            'gem_fractal_chart_caption' => "Chaque point est un niveau de densité de liens dans la galaxie. Un arc large signifie qu'elle mêle des zones très connectées et peu connectées ; un arc étroit signifie que le maillage est uniforme. L'anneau rouge marque où se trouve l'essentiel de la galaxie.",
            'gem_fractal_axis_x' => 'concentration des liens (α)',
            'gem_fractal_axis_y' => 'part de la galaxie',
            'gem_fractal_spread_label' => 'étendue',
            ...
            'gem_fractal_stat_density' => 'Densité des liens',
            'gem_fractal_stat_components' => 'Morceaux reliés',
            'gem_fractal_stat_diameter' => "Pas d'un bout à l'autre",
            'gem_fractal_summary_few' => 'Seulement quelques trous de ver connectés pour le moment.',
            'gem_fractal_summary_dense' => 'Petite et très interconnectée : presque chaque trou de ver partage un mot-clé avec presque tous les autres.',
            'gem_fractal_summary_moderate' => 'Un petit ensemble de trous de ver peu reliés.',
            'gem_fractal_summary_split' => 'Les trous de ver se répartissent en groupes séparés qui ne partagent aucun mot-clé.',
            'gem_fractal_summary_large' => "Une grande galaxie ; pour l'instant, seuls les nombres sont affichés.",
            'gem_fractal_chart_unavailable' => "Un graphique détaillé de la forme demande plus de trous de ver, et un maillage moins dense, que cette galaxie n'en a encore.",
