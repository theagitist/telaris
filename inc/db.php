...
const PROJECT_INFO_KEYS = [
    ...
    'gem_fractal_title', 'gem_fractal_intro', 'gem_fractal_loading',
...
function db_default_project_info_rows(string $enName = 'Telaris', string $enDescription = 'Weaving memory'): array {
    return [
        'en' => [
            ...
            'gem_fractal_title' => 'Fractal profile',
            'gem_fractal_intro' => 'Read-only diagnostic. Measures the structure of this galaxy\'s keyword-shared graph (wormholes linked when they share a keyword). It authors nothing.',
            'gem_fractal_loading' => 'Measuring…',
            'gem_fractal_dB_label' => 'Fractal dimension (d_B)',
            'gem_fractal_width_label' => 'Multifractal spectrum width',
            'gem_fractal_spectrum_label' => 'Singularity spectrum f(α)',
            'gem_fractal_gen_dims_label' => 'D0/D1/D2',
            'gem_fractal_gamma_label' => 'Degree exponent γ',
            'gem_fractal_stat_nodes' => 'Wormholes',
            'gem_fractal_stat_edges' => 'Connections',
            'gem_fractal_stat_meandeg' => 'Avg links',
            'gem_fractal_stat_components' => 'Components',
            'gem_fractal_stat_diameter' => 'Span',
            'gem_fractal_dB_low' => 'Chain-like: curation routes through a few hub keywords.',
            'gem_fractal_dB_mid' => 'Scale-free: a decentralized web of connections.',
            'gem_fractal_dB_high' => 'Hyper-dense: nearly everything sits a hop or two apart.',
            'gem_fractal_width_narrow' => 'Narrow: fairly uniform editorial intensity (close to monofractal).',
            'gem_fractal_width_wide' => 'Wide: heterogeneous intensity, the mark of genuinely federated curation.',
            'gem_fractal_reason_empty' => 'This galaxy has no wormholes yet.',
            'gem_fractal_reason_too_small' => 'Too few connected wormholes to measure.',
            'gem_fractal_reason_too_shallow' => 'The connections are too dense and shallow to show fractal scaling: nearly everything is a hop or two apart.',
            'gem_fractal_reason_too_large' => 'This galaxy is too large to profile on demand.',
            'gem_fractal_reason_cluster' => 'The fractal profile is measured per galaxy. Open a member galaxy to see its profile.',
            'gem_fractal_error' => 'Could not load the fractal profile.',
        ...
        'es' => [
            ...
            'gem_fractal_title' => 'Perfil fractal',
            'gem_fractal_intro' => 'Diagnóstico de solo lectura. Mide la estructura del grafo de palabras clave compartidas de esta galaxia (los agujeros de gusano se enlazan cuando comparten una palabra clave). No crea nada.',
            'gem_fractal_loading' => 'Midiendo…',
            'gem_fractal_dB_label' => 'Dimensión fractal (d_B)',
            'gem_fractal_width_label' => 'Ancho del espectro multifractal',
            'gem_fractal_spectrum_label' => 'Espectro de singularidad f(α)',
            'gem_fractal_gen_dims_label' => 'D0/D1/D2',
            'gem_fractal_gamma_label' => 'Exponente de grado γ',
            'gem_fractal_stat_nodes' => 'Agujeros de gusano',
            'gem_fractal_stat_edges' => 'Conexiones',
            'gem_fractal_stat_meandeg' => 'Enlaces prom.',
            'gem_fractal_stat_components' => 'Componentes',
            'gem_fractal_stat_diameter' => 'Alcance',
            'gem_fractal_dB_low' => 'En cadena: la curaduría pasa por unas pocas palabras clave centrales.',
            'gem_fractal_dB_mid' => 'Sin escala: una red descentralizada de conexiones.',
            'gem_fractal_dB_high' => 'Hiperdensa: casi todo queda a uno o dos saltos.',
            'gem_fractal_width_narrow' => 'Estrecho: intensidad editorial bastante uniforme (cercana a monofractal).',
            'gem_fractal_width_wide' => 'Amplio: intensidad heterogénea, la marca de una curaduría genuinamente federada.',
            'gem_fractal_reason_empty' => 'Esta galaxia todavía no tiene agujeros de gusano.',
            'gem_fractal_reason_too_small' => 'Hay muy pocos agujeros de gusano conectados para medir.',
            'gem_fractal_reason_too_shallow' => 'Las conexiones son demasiado densas y superficiales para mostrar escalamiento fractal: casi todo queda a uno o dos saltos.',
            'gem_fractal_reason_too_large' => 'Esta galaxia es demasiado grande para perfilar sobre la marcha.',
            'gem_fractal_reason_cluster' => 'El perfil fractal se mide por galaxia. Abre una galaxia miembro para ver su perfil.',
            'gem_fractal_error' => 'No se pudo cargar el perfil fractal.',
        ...
        'pt' => [
            ...
            'gem_fractal_title' => 'Perfil fractal',
            'gem_fractal_intro' => 'Diagnóstico somente leitura. Mede a estrutura do grafo de palavras-chave compartilhadas desta galáxia (os buracos de minhoca se ligam quando compartilham uma palavra-chave). Não cria nada.',
            'gem_fractal_loading' => 'Medindo…',
            'gem_fractal_dB_label' => 'Dimensão fractal (d_B)',
            'gem_fractal_width_label' => 'Largura do espectro multifractal',
            'gem_fractal_spectrum_label' => 'Espectro de singularidade f(α)',
            'gem_fractal_gen_dims_label' => 'D0/D1/D2',
            'gem_fractal_gamma_label' => 'Expoente de grau γ',
            'gem_fractal_stat_nodes' => 'Buracos de minhoca',
            'gem_fractal_stat_edges' => 'Conexões',
            'gem_fractal_stat_meandeg' => 'Ligações méd.',
            'gem_fractal_stat_components' => 'Componentes',
            'gem_fractal_stat_diameter' => 'Alcance',
            'gem_fractal_dB_low' => 'Em cadeia: a curadoria passa por poucas palavras-chave centrais.',
            'gem_fractal_dB_mid' => 'Sem escala: uma teia descentralizada de conexões.',
            'gem_fractal_dB_high' => 'Hiperdensa: quase tudo fica a um ou dois saltos.',
            'gem_fractal_width_narrow' => 'Estreito: intensidade editorial bastante uniforme (perto de monofractal).',
            'gem_fractal_width_wide' => 'Amplo: intensidade heterogênea, a marca de uma curadoria genuinamente federada.',
            'gem_fractal_reason_empty' => 'Esta galáxia ainda não tem buracos de minhoca.',
            'gem_fractal_reason_too_small' => 'Há poucos buracos de minhoca conectados para medir.',
            'gem_fractal_reason_too_shallow' => 'As conexões são densas e rasas demais para mostrar escalonamento fractal: quase tudo fica a um ou dois saltos.',
            'gem_fractal_reason_too_large' => 'Esta galáxia é grande demais para perfilar na hora.',
            'gem_fractal_reason_cluster' => 'O perfil fractal é medido por galáxia. Abra uma galáxia membro para ver o perfil dela.',
            'gem_fractal_error' => 'Não foi possível carregar o perfil fractal.',
        ...
        'fr' => [
            ...
            'gem_fractal_title' => 'Profil fractal',
            'gem_fractal_intro' => "Diagnostic en lecture seule. Mesure la structure du graphe de mots-clés partagés de cette galaxie (les trous de ver sont reliés lorsqu'ils partagent un mot-clé). Il ne crée rien.",
            'gem_fractal_loading' => 'Mesure en cours…',
            'gem_fractal_dB_label' => 'Dimension fractale (d_B)',
            'gem_fractal_width_label' => 'Largeur du spectre multifractal',
            'gem_fractal_spectrum_label' => 'Spectre de singularité f(α)',
            'gem_fractal_gen_dims_label' => 'D0/D1/D2',
            'gem_fractal_gamma_label' => 'Exposant de degré γ',
            'gem_fractal_stat_nodes' => 'Trous de ver',
            'gem_fractal_stat_edges' => 'Connexions',
            'gem_fractal_stat_meandeg' => 'Liens moy.',
            'gem_fractal_stat_components' => 'Composantes',
            'gem_fractal_stat_diameter' => 'Portée',
            'gem_fractal_dB_low' => "En chaîne : la curation passe par quelques mots-clés centraux.",
            'gem_fractal_dB_mid' => 'Sans échelle : une toile décentralisée de connexions.',
            'gem_fractal_dB_high' => "Hyperdense : presque tout se trouve à un ou deux sauts.",
            'gem_fractal_width_narrow' => 'Étroit : intensité éditoriale assez uniforme (proche du monofractal).',
            'gem_fractal_width_wide' => 'Large : intensité hétérogène, la marque d\'une curation vraiment fédérée.',
            'gem_fractal_reason_empty' => "Cette galaxie n'a pas encore de trous de ver.",
            'gem_fractal_reason_too_small' => 'Trop peu de trous de ver connectés pour mesurer.',
            'gem_fractal_reason_too_shallow' => "Les connexions sont trop denses et superficielles pour montrer une mise à l'échelle fractale : presque tout se trouve à un ou deux sauts.",
            'gem_fractal_reason_too_large' => 'Cette galaxie est trop grande pour être profilée à la volée.',
            'gem_fractal_reason_cluster' => 'Le profil fractal se mesure par galaxie. Ouvre une galaxie membre pour voir son profil.',
            'gem_fractal_error' => 'Impossible de charger le profil fractal.',
