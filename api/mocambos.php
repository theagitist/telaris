    ...
    if ($method === 'GET' && $action === 'validate') {
        ...
        foreach ($galaxias as $gal) {
            ...
            if ($constellationId !== null && $fullRefresh) {
                ...
                $isIncremental = true;
                // $diff['added'] will be processed in Phase 1 below (same as new items)
            ...
            // ── Phase 1: Fast batch insert of new nodes ─────────────
            ...
            foreach ($galaxiaItems as $itemIndex => $item) {
                ...
                // Extract content hash for download URL
                $contentHash = '';
                ...
                if ($mediaType === 'imagem') {
                    $dlUrl = $dlBase . '/acervo/download/' . $itemSlug . ($contentHash !== '' ? '/' . $contentHash : '');
                    ...
                    if ($iconUrl === null) {
                        $thumbUrl = $dlBase . '/acervo/thumbnail/' . $itemSlug;
